// SAMUEL/PEWIEBE, ALANA E GABRIEL
...
var Class = {
  create: function(prototype) { // Criar uma 'classe' JavaScript simples (uma função de construtor com um protótipo)
...
//-------------------------------------------------------------------------
// UTILITÁRIOS DE CARREGAMENTO DE ATIVOS
//-------------------------------------------------------------------------

Game.Load = {

  images: function(names, callback) { // carregar várias imagens e retorno de chamada quando TODAS as imagens tiverem sido carregadas
